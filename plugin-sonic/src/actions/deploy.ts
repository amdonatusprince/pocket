...
export class DeployAction {
    ...
    async deployERC20(deployTokenParams: IDeployERC20Params) {
        ...
        try {
            ...
            elizaLogger.error("Deploy ERC20 failed:", errorMessage);
            throw error;
        }
    }
    ...
    async deployERC721(deployNftParams: IDeployERC721Params) {
        ...
        try {
            ...
            const errorMessage = error instanceof Error ? error.message : 'Unknown error';
            elizaLogger.error("Deploy ERC721 failed:", errorMessage);
            throw error;
        }
    }
    ...
    async deployERC1155(deploy1155Params: IDeployERC1155Params) {
        ...
        try {
            ...
            elizaLogger.error("Deploy ERC1155 failed:", error instanceof Error ? error.message : String(error));
            throw error;
        }
    }
    ...
    async deployContract(
        ...
        try {
            // Map contract names to match the source definitions
            const contractMap = {
            ...
            elizaLogger.error(`Failed to deploy contract:`, error);
            throw error;
        }
    }
}
...
export const deployAction: Action = {
    ...
    handler: async (
        ...
        try {
            ...
            elizaLogger.error("Error during deploy:", errorMessage);
            callback?.({
